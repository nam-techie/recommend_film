  ...
  return <section className="rounded-2xl border border-accent/20 bg-gradient-to-r from-accent/[0.09] via-white/[0.03] to-transparent p-5">
    <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-start">
      <div className="min-w-0 flex-1">
        ...
        {plan === 'ultra' && <p className="mt-3 text-xs leading-relaxed text-fg-secondary">Phòng có 32 ghế thường + 4 ghế VIP. Ultra được chọn VIP và bật mic tại ghế VIP khi chủ phòng cho phép.</p>}
