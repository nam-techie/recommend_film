...
export interface CinemaPerson { memberId: string; displayName: string; avatar?: string; connected?: boolean; accountPlan?: 'normal' | 'premium' | 'ultra'; characterGender?: 'male' | 'female'; characterRevision?: number }
