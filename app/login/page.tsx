...
function LoginContent() {
  ...
  if (loading || user) return <main className="flex min-h-[calc(100dvh-4rem)] items-center justify-center bg-[#070912]"><div className="h-10 w-10 animate-spin rounded-full border-4 border-accent border-t-transparent" /></main>
